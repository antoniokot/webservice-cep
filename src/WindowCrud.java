...
public class WindowCrud extends JFrame{
     ...
     * Neste construtor será adicionado e posicionados ao painel principal(mainPainel)
    ...
    /**
     * Método main para carregar a janela.
     * Carrega a janela criada em {@link WindowCrud()} no método run().
